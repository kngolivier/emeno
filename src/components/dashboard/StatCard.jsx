  ...
  return (
    <div
      ...
      className={`
        ...
        ${to ? "hover:border-secondary/30 dark:hover:border-secondary/50 hover:shadow-md active:scale-95" : ""}
      `}
    >
      ...
      <div className="min-w-0">
        <p className="text-[8px] md:text-[9px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest leading-none mb-1 truncate">
          {title}
        </p>
