...
export default function Footer() {
  ...
  // On peut choisir d'afficher un footer minimaliste ou rien pendant le chargement
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 items-center">
               ...
               <div>
                  ...
                  <p className="text-xs font-bold text-primary dark:text-white">{settings.contact?.phone}</p>
               </div>
            </div>
          </div>
        ...
        <div className="pt-10 border-t border-slate-100 dark:border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-[9px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-[0.3em] text-center">
            © {currentYear} {settings.name} Livraison • GABON
          </p>
          <div className="flex gap-8">
            {settings.socialMedia?.instagram && (
              <a href={settings.socialMedia.instagram} target="_blank" rel="noreferrer" className="text-[9px] font-black text-slate-400 dark:text-slate-600 hover:text-secondary transition-colors uppercase tracking-[0.2em] italic">Instagram</a>
            )}
