...
import DriverMap from "./DriverMap"; // Ajuste le chemin si DriverMap est dans le même dossier
...
export default function DriversList() {
  ...
  const getStatusStyle = (s) => {
    switch (s) {
      ...
      default: return "bg-slate-50 dark:bg-white/5 text-slate-400 border-slate-100 dark:white/5";
    }
  };
  ...
  return (
    <div className="space-y-8 font-sans pb-10 transition-colors duration-300">
      ...
      {activeTab === "list" ? (
        ...
        /* --- SUPRESSION DE L'ANCIENNE MAP COPIÉE/COLLÉE & INJECTION DU COMPOSANT EMENO PREMIUM V2 --- */
