      ...
      <article className="max-w-3xl mx-auto bg-white dark:bg-[#0B1120] p-8 md:p-12 rounded-[2rem] border border-slate-100 dark:border-white/5 shadow-xl">
        ...
        <div className="space-y-8 text-slate-600 dark:text-slate-400">
          <section>
            ...
            <p>EMENO collecte des informations d'identification (nom, téléphone, email) , des informations de compte, des données liées aux livraisons, des données de localisation pour les livreurs et des données techniques (IP, appareil).</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-primary dark:text-white mb-3">Finalités et Base légale</h2>
            <p>Les données servent à gérer les comptes, authentifier les utilisateurs, assurer le suivi des livraisons et respecter les obligations légales.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-primary dark:text-white mb-3">Partage et Conservation</h2>
            <p>EMENO ne vend pas vos données. Elles sont partagées uniquement avec les livreurs, partenaires techniques ou autorités compétentes. Elles sont conservées uniquement pendant la durée nécessaire au service.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-primary dark:text-white mb-3">Vos droits</h2>
            <p>Vous disposez d'un droit d'accès, de rectification, d'effacement, de limitation, d'opposition et de portabilité.</p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-primary dark:text-white mb-3">Droit applicable</h2>
            <p>Régie par les lois en vigueur en République Gabonaise.</p>
          </section>
        </div>
      </article>
    </div>
