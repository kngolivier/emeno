...
import { Plus, Eye, Phone, Mail, UserCheck, UserMinus, ExternalLink } from "lucide-react";
    ...
    <div className="space-y-8 font-sans pb-10">
      ...
      {clients.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 px-6 bg-white border border-dashed border-slate-200 rounded-[3rem] text-center space-y-4">
          ...
          <div>
            <h3 className="font-display font-black text-xl italic text-primary uppercase tracking-tight">Aucun client</h3>
              ...
              <div key={c._id} className={`bg-white p-6 rounded-[2.5rem] border border-slate-50 shadow-sm transition-all ${c.status === "DELETED" ? "opacity-40" : ""}`}>
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-display font-black text-primary italic text-lg tracking-tight truncate uppercase leading-tight">
                      {c.nom} {c.prenom}
                    </h3>
                ...
                <div className="flex gap-2">
                  ...
                  <button 
                    ...
                    className={`px-4 py-3 rounded-xl border transition-colors ${c.status === "ACTIVE" ? "border-rose-100 text-rose-500" : "border-emerald-100 text-emerald-500"}`}
                  >
                    <UserCheck size={16} />
                  </button>
                </div>
