      ...
      <form onSubmit={handleSubmit} className="p-8 space-y-6">
        ...
        <div className="pt-4 border-t border-slate-100 flex items-center justify-between gap-6">
          ...
          <div className="flex items-end pt-5">
            <button type="submit" className="w-full md:w-auto bg-blue-600 text-white px-10 py-3 rounded-2xl hover:bg-blue-700 transition-all shadow-lg shadow-blue-200 font-bold flex items-center gap-2">
              <Plus size={20} />
              Créer la commande
            </button>
          </div>
