...
export default function NewOrderForm({ onAdd, onClose }) {
  ...
  const inputClass = "w-full bg-slate-50/50 dark:bg-primary border-2 border-slate-50 dark:border-white/5 rounded-xl p-3 md:p-4 text-sm font-bold text-primary dark:text-primary outline-none focus:border-secondary/20 dark:focus:border-secondary/40 focus:bg-white dark:focus:bg-white/10 transition-all placeholder:text-slate-300 dark:placeholder:text-slate-600";
